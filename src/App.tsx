...
export default function App() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              },
              {
                ...
                icon: <Laptop className="text-google-blue" />,
              ...
              },
              {
                ...
                icon: <LayoutDashboard className="text-google-green" />,
                link: "https://knowledge.workspace.google.com/admin/getting-started/sign-in-to-your-admin-console?hl=fr"
              }
            ].map((item, i) => (
              <div key={i} className="google-card group">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-2xl bg-background group-hover:bg-primary-light transition-colors">{item.icon}</div>
                  <div>
                    <h3 className="font-bold text-secondary-dark text-base">{item.title}</h3>
                    <p className="text-sm text-secondary mt-1 leading-relaxed">{item.desc}</p>
                    <a href={item.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-xs font-bold text-primary-dark mt-4 hover:underline">
          ...
          <div className="pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                {
                  title: "Gemini",
                  desc: "L'assistant IA de Google pour booster la créativité et la productivité.",
                  icon: <Sparkles className="text-indigo-600" />,
                  link: "https://gemini.google.com/"
                },
                {
                  title: "Gems",
                  desc: "Créez des versions personnalisées de Gemini pour des tâches spécifiques.",
                  icon: <Users className="text-pink-600" />,
                  link: "https://gemini.google/ch/overview/gems/?hl=fr"
                },
                {
                  title: "NotebookLM",
                  desc: "Un assistant de recherche intelligent qui utilise vos propres documents.",
                  icon: <Brain className="text-google-blue" />,
                  link: "https://notebooklm.google.com/"
                }
              ].map((item, i) => (
                <div key={i} className="google-card !p-5">
                  <div className="flex flex-col gap-3">
                    <div className="p-3 w-fit rounded-2xl bg-background">{item.icon}</div>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-6 rounded-2xl border-2 border-outline bg-surface">
              <h3 className="font-bold text-lg flex items-center gap-3 text-secondary-dark">
                <span className="w-8 h-8 rounded-full bg-outline/20 text-secondary flex items-center justify-center text-xs font-bold">NON</span>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <a href="https://www.infomaniak.com/" target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-background rounded-full text-xs font-bold text-secondary hover:bg-outline/30 transition-colors">Infomaniak</a>
                <a href="https://www.gandi.net/" target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-background rounded-full text-xs font-bold text-secondary hover:bg-outline/30 transition-colors">Gandi.net</a>
                <a href="https://www.ovhcloud.com/" target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-background rounded-full text-xs font-bold text-secondary hover:bg-outline/30 transition-colors">OVH</a>
                <a href="https://www.godaddy.com/" target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-background rounded-full text-xs font-bold text-secondary hover:bg-outline/30 transition-colors">GoDaddy</a>
              </div>
            </div>

            <div className="p-6 rounded-2xl border-2 border-primary-dark bg-primary-light/30">
              <h3 className="font-bold text-lg flex items-center gap-3 text-secondary-dark">
                <span className="w-8 h-8 rounded-full bg-primary-dark text-white flex items-center justify-center text-xs font-bold">OUI</span>
              ...
              <button 
                ...
                className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-primary-dark hover:gap-3 transition-all"
              >
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-xl border border-[#DADCE0] bg-white relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-[0.03]">
              <BookOpen className="w-32 h-32" />
            </div>
            <div className="relative z-10">
              <h3 className="text-lg font-bold flex items-center gap-2 text-secondary-dark">
                <BookOpen className="w-6 h-6 text-primary" />
                Carnet de bord
              </h3>
              <p className="text-secondary text-sm mt-2 max-w-md leading-relaxed">
                Utilisez notre carnet de bord pour suivre vos configurations étape par étape et garder une trace de vos décisions techniques.
              </p>
              <a 
                href="https://docs.google.com/spreadsheets/d/1p3m4iIlvchRmpLIDi4FharntIKeYCjSkK-p9ca1DADA/copy?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 mt-5 px-5 py-2.5 bg-primary text-white hover:bg-primary-dark rounded-md text-sm font-medium transition-all shadow-sm active:scale-95"
              >
                Faire une copie du carnet <ExternalLink className="w-4 h-4" />
              </a>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-xl border border-primary-light bg-primary-light/30 text-center">
            <h3 className="text-lg font-bold text-secondary-dark">Besoin d'aide personnalisée ?</h3>
            <p className="mt-1 text-sm text-secondary">Contactez Alain Doutrelepont</p>
            <a href="mailto:alain@edunum.be" className="mt-4 inline-flex items-center gap-2 px-6 py-2 bg-primary text-white rounded-md font-medium hover:bg-primary-dark transition-colors shadow-sm">
              alain@edunum.be <ArrowRight className="w-4 h-4" />
            </a>
          </div>
        </div>
      )
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Progress Bar (Top) */}
      <div className="h-1 w-full bg-outline/30 fixed top-0 z-[60] flex">
        <motion.div 
          className="h-full bg-google-blue"
          initial={{ width: 0 }}
          animate={{ width: `${Math.min(25, (completedSteps.length / steps.length) * 100)}%` }}
          transition={{ duration: 0.5 }}
        />
        <motion.div 
          className="h-full bg-google-red"
          initial={{ width: 0 }}
          animate={{ width: `${Math.max(0, Math.min(25, (completedSteps.length / steps.length) * 100 - 25))}%` }}
          transition={{ duration: 0.5, delay: 0.1 }}
        />
        <motion.div 
          className="h-full bg-google-yellow"
          initial={{ width: 0 }}
          animate={{ width: `${Math.max(0, Math.min(25, (completedSteps.length / steps.length) * 100 - 50))}%` }}
          transition={{ duration: 0.5, delay: 0.2 }}
        />
        <motion.div 
          className="h-full bg-google-green"
          initial={{ width: 0 }}
          animate={{ width: `${Math.max(0, Math.min(25, (completedSteps.length / steps.length) * 100 - 75))}%` }}
          transition={{ duration: 0.5, delay: 0.3 }}
        />
      </div>

      {/* Top Header */}
      <header className="h-16 bg-surface border-b border-outline flex items-center justify-between px-4 md:px-6 sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <button 
            onClick={() => setIsSidebarOpen(!isSidebarOpen)} 
            className="p-2 hover:bg-[#F1F3F4] rounded-full text-secondary md:hidden"
          >
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-2 px-4 py-1.5 bg-white rounded-full text-xs font-bold border border-outline shadow-sm">
            ...
            <span className="text-secondary-dark">Workspace Setup</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`
          ...
          bg-surface border-r border-outline w-full md:w-80 shrink-0
          transform transition-transform duration-300 ease-in-out
          ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
        `}>
          <div className="h-full flex flex-col py-6">
            <div className="px-6 mb-6">
              <h2 className="text-xs font-bold text-secondary uppercase tracking-widest mb-4">Parcours de configuration</h2>
              <div className="flex items-center justify-between mb-2">
                <span className="text-[11px] font-medium text-secondary">Progression globale</span>
                <span className="text-[11px] font-bold text-primary-dark">{Math.round((completedSteps.length / steps.length) * 100)}%</span>
              </div>
            ...
            <nav className="flex-1 overflow-y-auto pr-4 space-y-1">
              {steps.map((step, idx) => (
                <button
                  key={step.id}
                  onClick={() => {
                  ...
                  className={`
                    w-full flex items-center gap-4 py-3.5 pl-6 pr-4 transition-all text-left group
                    ${activeStep === idx 
                      ? 'sidebar-item-active' 
                      : 'text-secondary hover:bg-[#F1F3F4] hover:text-secondary-dark rounded-r-full'}
                  `}
                >
                  <div className={`
                  ...
                  <span className={`text-sm tracking-tight ${activeStep === idx ? 'font-semibold' : 'font-medium'}`}>{step.title}</span>
                </button>
              ))}
            </nav>

            <div className="px-6 pt-6 mt-4 border-t border-outline">
              <div className="p-4 rounded-2xl bg-primary-light/50 border border-primary/10">
                <p className="text-[11px] text-primary-dark font-medium leading-relaxed">
                  Besoin d'aide ? Consultez la documentation officielle ou contactez votre administrateur.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
                <div className="mb-8 flex items-center justify-between">
                  <div>
                    <span className="text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                      <span className="text-google-blue">Étape</span>
                      <span className="text-google-red">{activeStep + 1}</span>
              ...
              <div className="hidden sm:block">
                {completedSteps.includes(steps[activeStep].id) && (
                  <div className="flex items-center gap-2 px-4 py-2 bg-google-green/10 text-google-green rounded-full text-sm font-bold border border-google-green/20">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-12 pt-8 border-t border-outline flex flex-col sm:flex-row items-center justify-between gap-6">
                  <button
                    onClick={() => toggleStep(steps[activeStep].id)}
                    className={`
                      w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3 rounded-full font-bold transition-all
                      ${completedSteps.includes(steps[activeStep].id)
                        ? 'bg-google-green text-white shadow-md'
                        : 'bg-surface border-2 border-outline text-secondary-dark hover:border-primary-dark hover:text-primary-dark'}
                    `}
                  >
                    {completedSteps.includes(steps[activeStep].id) ? (
                      <>
                  ...
                  <div className="flex gap-4 w-full sm:w-auto">
                    {activeStep > 0 && (
                      <button
                        ...
                        className="flex-1 sm:flex-none px-8 py-3 bg-surface border-2 border-outline text-secondary-dark rounded-full font-bold hover:bg-[#F1F3F4] transition-all"
                      >
                        Précédent
                      </button>
                    )}
                    {activeStep < steps.length - 1 && (
                      <button
                        onClick={() => setActiveStep(activeStep + 1)}
                        className="flex-1 sm:flex-none primary-btn px-10"
                      >
                        Suivant
            ...
            <footer className="mt-12 text-center text-secondary/60 text-[11px]">
